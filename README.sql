...
-- This project is designed to generate sample data for A Credit Card Company, CPI Card Group, Inc., data warehouse.
...
--5. You need have a user able to create/remove tables, functions, procedures,sequences and indexes
